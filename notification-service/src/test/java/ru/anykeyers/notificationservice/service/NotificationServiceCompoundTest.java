...
class NotificationServiceCompoundTest {
    ...
    void setUp() {
        notificationServiceCompound = new NotificationServiceCompound(
                executorService, List.of(pushNotificationService, smtpEmailService)
        );
    }
    ...
    void testNotify() {
        ...
        Mockito.verify(pushNotificationService).notify(user, notification);
        Mockito.verify(smtpEmailService).notify(user, notification);
    }
